...
create table Vaga_competencia(id_vaga_competencia int not null AUTO_INCREMENT, id_vaga int not null, tempo int not null, id_competencia int not null, PRIMARY KEY (id_vaga_competencia));

create table vaga (id_vaga int not null AUTO_INCREMENT, id_empresa int not null, faixa_salarial int not null, descricao char(255) not null, primary key (id_vaga) );
